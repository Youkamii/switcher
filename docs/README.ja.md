...
- TFSD (Token Full Self-Driving): アクティブなアカウントのいずれかの使用量枠(5 Hours・Weekly・Fable など)が90%に達すると、すべての枠に余裕があるアカウントのうちボトルネックが最も低いところへ自動切り替え。満杯の枠が30分以内にリセットされる場合は切り替えず待機。トレイの設定でオン(既定はオフ)。
