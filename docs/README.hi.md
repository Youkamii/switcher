...
**npm से इंस्टॉल करें (अनुशंसित)** — Node.js 18 या उससे ऊपर
...
`switcher` कमांड पहली बार चलने पर इंस्टॉल किए गए npm पैकेज के समान वर्ज़न वाला आधिकारिक रिलीज़ बिल्ड डाउनलोड करती है (उसके बाद तुरंत खुलती है)। बाइनरी कोड-साइन नहीं है, इसलिए npm से इंस्टॉल करने पर भी SmartScreen चेतावनी दिखा सकता है। अपडेट अपने आप होता है — हर बार चलाने पर नई रिलीज़ की जाँच होती है और अगली बार चलाने पर लागू होती है।

**सीधा डाउनलोड** — [डाउनलोड संग्रह](https://github.com/Youkamii/switcher/releases/tag/v1.8.5) से `switcher-win-x64-latest.zip` डाउनलोड करें, unzip करके `switcher.exe` चलाएँ। (Windows 10/11 64-बिट)
...
`switcher` कमांड पहली बार चलने पर इंस्टॉल किए गए npm पैकेज के समान वर्ज़न वाला आधिकारिक रिलीज़ बिल्ड डाउनलोड करती है (उसके बाद तुरंत खुलती है)। App साइन या notarize नहीं है, इसलिए npm से इंस्टॉल करने पर भी "अज्ञात डेवलपर" चेतावनी दिख सकती है। अपडेट अपने आप होता है — हर बार चलाने पर नई रिलीज़ की जाँच होती है और अगली बार चलाने पर लागू होती है।

**सीधा डाउनलोड** — [डाउनलोड संग्रह](https://github.com/Youkamii/switcher/releases/tag/v1.8.5) से `switcher-mac-arm64-latest.zip` डाउनलोड करें, unzip करके `switcher.app` चलाएँ। केवल Apple Silicon के लिए — Intel Mac पर नीचे दिए [सोर्स से बिल्ड करें](#सोर्स-से-बिल्ड-करें) से इंस्टॉल करें।
...
- UI भाषा बदलने के लिए मेन्यू बार के W आइकन पर राइट-क्लिक → सेटिंग्स → भाषा (한국어·English·日本語·简体中文·繁體中文·हिन्दी)।
- बूट पर स्वतः चलना डिफ़ॉल्ट रूप से चालू है — ट्रे सेटिंग्स → बूट पर स्वतः चलाएँ से बंद कर सकते हैं (System Settings → Login Items में भी दिखता है)।
- हर बार चलाने पर नई रिलीज़ की जाँच करके ऑटो-अपडेट होता है (अगली बार चलाने पर लागू) — ट्रे सेटिंग्स → ऑटो-अपडेट से बंद कर सकते हैं।
...
- UI भाषा: ट्रे → सेटिंग्स → भाषा से 6 भाषाओं (कोरियाई·अंग्रेज़ी·जापानी·सरलीकृत चीनी·पारंपरिक चीनी·हिन्दी) में स्विच।
- ऑटो-अपडेट·बूट पर स्वतः चलना: ट्रे सेटिंग्स से चालू/बंद। डेस्कटॉप शॉर्टकट केवल Windows पर।
...
- ब्लैक मॉनिटर: 🌙 बटन या ट्रे मेनू से सभी स्क्रीनें सबसे ऊपर काले पर्दे से ढक जाती हैं। माउस हिलाने पर कर्सर के आसपास धुआँ छँटने जैसा हिस्सा दिखता है; माउस को 1–2 सेकंड ज़ोर से हिलाएँ या ESC दबाएँ — आख़िरी कर्सर की जगह से रोशनी फैलते हुए पर्दा हट जाता है। macOS पर फ़ुलस्क्रीन ऐप्स के ऊपर नहीं ढक सकता।
- अकाउंट जानकारी छिपाना: 🙈 बटन कार्ड पर ईमेल और GitHub अकाउंट नाम धुंधला कर देता है — स्क्रीन शेयर/स्क्रीनशॉट सुरक्षा। दोबारा दबाने पर वापस दिखता है।
- स्क्रीन चमक नियंत्रण: DISPLAY सेक्शन में हर मॉनिटर का स्लाइडर असली बैकलाइट बदलता है (Windows पर DDC/CI, macOS पर बिल्ट-इन डिस्प्ले)। DDC/CI बंद वाले मॉनिटर और Mac के एक्सटर्नल मॉनिटर पर असमर्थित होने का संकेत दिखता है।
- TFSD (Token Full Self-Driving): सक्रिय अकाउंट की कोई भी उपयोग विंडो (5 Hours, Weekly, Fable आदि) 90% पर पहुँचते ही उस अकाउंट पर स्वतः स्विच जिसकी बॉटलनेक सबसे कम है — केवल वही अकाउंट लक्ष्य बन सकते हैं जिनकी हर विंडो में गुंजाइश हो। भरी विंडो 30 मिनट में रीसेट होने वाली हो तो स्विच के बजाय प्रतीक्षा। ट्रे सेटिंग्स से चालू करें (डिफ़ॉल्ट बंद)।
...
[GitHub CLI (gh)](https://cli.github.com) इंस्टॉल हो तो विजेट में GITHUB सेक्शन दिखता है। अकाउंट जोड़ने के लिए विजेट का "＋ अकाउंट जोड़ें" बटन इस्तेमाल करें — URL और वन-टाइम कोड दिखेगा, ब्राउज़र में डालते ही हो गया (टर्मिनल `gh auth login` भी चलता है)। फिर विजेट से स्विच कर सकते हैं — अंदरूनी तौर पर यह `gh auth switch` वाला ही रास्ता लेता है, और हर स्विच पर `gh auth setup-git` चलाता है ताकि git push/pull (HTTPS) सक्रिय अकाउंट को फ़ॉलो करे। टोकन gh के keyring में रहते हैं; विजेट उन्हें नहीं छूता।
...
- अकाउंट जोड़ने और हर स्विच पर चलने वाला `gh auth setup-git` ग्लोबल git कॉन्फ़िग में github.com के लिए gh को credential helper के रूप में स्थायी रूप से दर्ज करता है और मौजूदा GCM सेटअप की जगह लेता है — हटाने के लिए `git config --global --unset-all credential.https://github.com.helper`।
