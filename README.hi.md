...
`switcher` कमांड पहली बार चलने पर लेटेस्ट रिलीज़ बिल्ड अपने आप डाउनलोड कर लेती है (उसके बाद तुरंत खुलती है)। यह ब्राउज़र डाउनलोड नहीं है, इसलिए SmartScreen की चेतावनी नहीं आती। अपडेट के लिए विजेट बंद करके वही इंस्टॉल कमांड दोबारा चलाएँ।
...
- बूट पर अपने आप शुरू कराने के लिए `Win+R` → `shell:startup` फ़ोल्डर में exe का शॉर्टकट रख दें।
