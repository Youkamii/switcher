...
const ko = {
  ...
  exhaustTooltip: "예상 소진 — 현재 속도가 유지되면 리셋 전에 한도에 닿습니다",
...
const en: Messages = {
  ...
  exhaustTooltip: "Predicted exhaustion — at the current pace this limit will be hit before it resets",
...
const ja: Messages = {
  ...
  exhaustTooltip: "枯渇予測 — 現在のペースが続くとリセット前に上限に達します",
...
const zhCN: Messages = {
  ...
  exhaustTooltip: "预计耗尽 — 按当前速度将在重置前达到上限",
...
const zhTW: Messages = {
  ...
  exhaustTooltip: "預計耗盡 — 按目前速度將在重置前達到上限",
...
const hi: Messages = {
  ...
  exhaustTooltip: "अनुमानित समाप्ति — मौजूदा गति पर रीसेट से पहले लिमिट खत्म हो जाएगी",
